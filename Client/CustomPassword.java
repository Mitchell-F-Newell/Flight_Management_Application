...
/**
 *This class contains the CustomPassword logic and construciton.
 * @author Code created by: Jared Brintnell, Mitchell Newell & Davis Roman
 * ID: 30002066, 30006529, 30000179
 * @version 1.0
 * @since April 6th, 2017
 */
public class CustomPassword extends JPasswordField implements FocusListener {
	/**
	 * one of the symbols that is to be displayed when the filed is active.
	 */
	private Icon symbol;
	...
	/**
	 * the shape of the interatable object (text field)
	 */
	private Shape fieldShape;
	
	/**
	 * The default text that is set into the text field.
	 */
	private String defaultString;
	
	/**
	 * sets and contructs the interactable gui/text field where that password will be entered.
	 ...
	 */
	public CustomPassword (int size, String text) {
		super(size);
		defaultString = text;
